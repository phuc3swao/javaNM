...
//        String info = ad.getUserInfo(userName);
        UserProfileDAO upD = new UserProfileDAO();
        UserProfile userProfile = upD.getUserByUsername(userName);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        UserProfileDAO upD = new UserProfileDAO();
        upD.upsertUser(user);
        response.sendRedirect("userDetail?user=" + user.getUserName() + "&flag=1");
    }
