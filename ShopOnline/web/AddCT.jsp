            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-10 ftco-animate">
                        <form action="add_C" method="post" class="billing-form">
                            <h3 class="mb-4 billing-heading">Add Category</h3>
                            <p style="color: red">${requestScope.existC}</p>
                            <p style="color: green">${requestScope.success}</p>
                            <div class="row align-items-end">                               
                            </div>                               
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="country" >ID: <input type="text" name="id" placeholder="Enter id (Number)"/></label><br>
                                    <label for="country" >Category Name:</label><br>                                      
                                    <input type="text" name="nameCT" placeholder="Enter Name">
                                    
                                </div>
                            </div>

                            
                                <input class="btn btn-primary py-3 px-4" type="submit" value="SUBMIT" style="width: 30%"/>
                        </form><!-- END -->
