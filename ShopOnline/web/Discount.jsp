<%-- 
    Document   : Discount
    Created on : Jul 8, 2022, 10:10:14 PM
    Author     : Admin
--%>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-10 ftco-animate">
                        <form action="createDiscount" method="post" class="billing-form">
                            <h3 class="mb-4 billing-heading">Create discount code</h3>                            
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="code"  name="code" readonly="true" style="width: 100%"></input>
                                    <input type="button" value="Generate Code" onclick="randomString()"><br> 
                                    <label for="value">Value:</label><br>
                                    <input type="text" id="value" name="value" style="width: 100%"><br>
                                </div>
                            </div>                     
                            <div class="row mt-5 pt-3 d-flex">
                                <div class="col-md-6">
                                    <div class="cart-detail bg-light p-3 p-md-4">
                                        <input class="btn btn-primary py-3 px-4" type="submit" value="Create" style="width: 100%"/>
                                    </div>
