            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mb-5 ftco-animate">
                        <a href="${image}" class="image-popup prod-img-bg"><img src="${image}" class="img-fluid" alt="Colorlib Template"></a>
                    </div>
                    <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                        ...
                        <div class="row mt-4">                         
                            ...
                            <div class="input-group col-md-6 d-flex mb-3">
                                <p class="text-left mr-4">
                                    <a href="#" class="mr-2">Xếp hạng : </a>
                                    <a href="#"><span class="ion-ios-star-outline"></span></a>                               
                                </p>                                
                                <input type="number" id="quantity" name="rate" class="quantity form-control input-number" value="5" min="1" max="5">
                        ...
                        <p style="padding-top: 30px">
                            <input type="submit" value="Gửi đánh giá" class="btn btn-black py-3 px-5 mr-2" />
                            <a href="orderview" class="btn btn-primary py-3 px-5">Hủy/Cancel</a></p>
                        </form>
                    </div>
                </div>
