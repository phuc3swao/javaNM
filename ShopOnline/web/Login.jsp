<%-- 
    Document   : Login
    Created on : Mar 2, 2022, 8:51:27 PM
    Author     : Admin
--%>
                    ...
                    <div class="col-lg-12 d-block">
                        <div class="row d-flex">
                            <div class="col-md pr-4 d-flex topper align-items-center">
                                ...
                                <span class="text">+ 0989 xxx xxxx</span>
                            </div>
                            <div class="col-md pr-4 d-flex topper align-items-center">
                    ...
                    <div class="col-md-6 order-md-last d-flex" >
                        ...
                        <form action="login" class="bg-white p-5 contact-form" method="post">
                            ...
                            <div class="form-group">
                                <input type="text" name="Luser" class="form-control" placeholder="Tên đăng nhập">
                            </div>
                            <div class="form-group">
                                <input type="password" name="Lpass" class="form-control" placeholder="Mật Khẩu">
                            </div>                                                       
                            <div class="form-group">
                                <input type="submit" value="Login/Đăng nhập" class="btn btn-primary py-3 px-5">
                                <h6 style="padding-top: 7px; color: tomato">${requestScope.lfail}</h6>
                                <a href="forgotpass" style="color: fuchsia">Quên mật khẩu</a>
                            </div>
                        </form>

                    </div>
                    <div class="col-md-6 order-md-last d-flex">
                        <form action="register" class="bg-white p-5 contact-form" method="post">
                            <h2 class="heading">ĐĂNG KÝ</h2>
                            <div class="form-group">
                                <input type="text" name="Ruser" class="form-control" placeholder="Tên đăng nhập"> 
                                <h6 style="padding-top: 7px; color: tomato">${requestScope.dupuser}</h6>
                            </div>

                            <div class="form-group">
                                <input type="password" name="Rpass" class="form-control" placeholder="Mật khẩu">
                            </div>
                            <div class="form-group">
                                <input type="password" name="RRpass" class="form-control" placeholder="Nhập lại mật khẩu">
                                <h6 style="padding-top: 7px; color: tomato">${requestScope.diffp}</h6> 
                            </div>  

                            <div class="form-group">
                                <input type="submit" value="Đăng ký" class="btn btn-primary py-3 px-5"><br>
                                <h6 style="padding-top: 7px; color: #a9fd00">${requestScope.Rsuccess}</h6>                               
                            </div>
                        </form>
                    </div>                  
                </div>
