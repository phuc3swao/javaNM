...
<html lang="en">
    ...
    <body class="goto-here">
        ...
        <section class="ftco-section ftco-cart">           
            <div class="container">
                <div><a href="add_C" style="color: #005cbf; font-size: 20px;text-align: end">Add Category</a></div><br>
                        ...
                        <div class="cart-list">
                            <table class="table">
                                ...
                                <c:forEach items="${requestScope.listCate}" var="C">
                                    <tbody>
                                        <tr class="text-center">
                                            <td class="product-remove">${C.cid}</td>
                                            ...
                                            <td class="total">
                                                ...
                                                <a href="admin-delete-cate?cid=${C.cid}"  style="color: red">Xóa</a>
                                            </td>
                                        </tr><!-- END TR-->                                      
                                    </tbody>
                                </c:forEach>
