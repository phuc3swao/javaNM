...
<html lang="en">
    ...
    <body class="goto-here">
        ...
        <section class="ftco-section ftco-cart">           
            <div class="container">
                <div><a href="add_p" style="color: #005cbf; font-size: 20px;text-align: end">Thêm sản phẩm</a></div><br>
                <div><a href="statistic" style="color: #005cbf; font-size: 20px;text-align: end">Xem thống kê</a></div><br>
                <form action="manageproduct" method="post">                                     
                    <div class="col-md-12">                        
                        Id sản phẩm:<input name="idSP" value="${id}">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        Tên sản phẩm :<input name="nameSP" value="${name}">
                        ...
                        <div class="cart-list">
                            <table class="table">
                                ...
                                <c:forEach items="${requestScope.listP}" var="x">
                                    <tbody>
                                        <tr class="text-center">
                                            <td class="product-remove">${x.id}</td>
                                            ...
                                            <td class="price">${x.price} vnd</td>

                                            <td class="quantity">
                                                <div class="input-group mb-3">
                                                    <input type="text" name="quantity" class="quantity form-control input-number" value="${x.color}" >
                                                </div>
                                            </td>

                                            <td class="total">
                                                <a href="update_p?idsp=${x.id}" style="color: fuchsia">Cập nhật</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                                <a href="#" onclick="showMess(${x.id})" style="color: red">Xóa</a>
                                            </td>
                                        </tr><!-- END TR-->                                      
                                    </tbody>
                                </c:forEach>
                ...
                <nav style="margin: 20px auto; width: 500px" aria-label="...">              
                    <ul class="pagination pagination-lg">
                        <c:forEach begin="1" end="${totalPage}" var="i">
                            <li class="page-item ${indexPage == i?"active":""}"><a class="page-link" href="manageproduct?page=${i}">${i}</a></li>
                        </c:forEach>
                    </ul>
                </nav>
            </div>
        ...
        <script>
                                ...
                                function showMess(id) {
                                    var option = confirm('Xóa sản phẩm với id = ' + id + ' chắc chưa ???');
                                    if (option === true) {
                                        window.location.href = 'delete_p?idsp=' + id;
                                    }
                                }
        </script>
