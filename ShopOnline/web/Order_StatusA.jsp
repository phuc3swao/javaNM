            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-9 ftco-animate text-center">
                        <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Đơn hàng</span></p>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-10 ftco-animate">
                        <form action="changestatus" method="post" class="billing-form">
                            <h3 class="mb-4 billing-heading">Cập nhật trạng thái / Exception</h3>                            
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="streetaddress">Chọn trạng thái đơn hàng</label>
                                    <input type="text" name="oid" value="${requestScope.oid}" style="width: 30%; text-align: center"><br> 
                                    <label for="streetaddress">Chọn trạng thái đơn hàng :</label>
                                    <select name="status">
                            ...
                            <div class="col-md-6">
                                <div class="cart-detail bg-light p-3 p-md-4">
                                    <input class="btn btn-primary py-3 px-4" type="submit" value="XÁC NHẬN" style="width: 30%; text-align: center"/>
                                </div>
                            </div>                           
                        </form>  
