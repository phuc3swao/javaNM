...
<html lang="en">
    ...
    <body class="goto-here">
            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-9 ftco-animate text-center">
                        ...
                        <h1 class="mb-0 bread">Quản lý đơn hàng</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="ftco-section ftco-cart">           
            <div class="container">
                <div class="row">
                    <form action="order_all" method="post">                                     
                        <div class="col-md-12">                        
                            Trạng thái của đơn hàng : <select name="status">
                                <option value="">Trạng thái đơn hàng</option>
                                <option value="Nhận đơn">-Nhận đơn</option>
                                <option value="Đã giao việc">-Đã giao việc</option>
                                <option value="Đã có hàng">-Đã có hàng</option>
                                <option value="Đã giao hàng">-Đang giao hàng</option>
                                <option value="Bán thành công">-Bán thành công</option>
                                <option value="Bán thất bại">-Bán thất bại</option>
                            </select>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            Tên khách hàng :<input name="user">
                        ...
                        <div class="cart-list">
                            <table class="table">
                                ...
                                <c:forEach items="${requestScope.listO}" var="x">
                                    <tbody >
                                        <tr>
                                            <td class="product-remove">${x.oid}</td>                                                                           
                                            <td>${x.pid}</td>                                                                           
                                            <td>${x.customer}</td>                                                                           
                                            <td>${x.date}</td>                                                                           
                                            <td>${x.status}</td>                                                                           
                                            ...
                                            <td>
                                                <c:choose>
                                                    ...
                                                    <c:when test = "${x.status == 'Bán thành công'}">
                                                        <a style="color: red" href="#" onclick="showMess(${x.oid})">Xóa</a> &nbsp;&nbsp;&nbsp;
                                                        <a href="changestatus?oid=${x.oid}">Cập nhật</a>
                                                    </c:when>

                                                    <c:when test = "${x.status == 'Nhận đơn'}">
                                                        <a href="orderproc?oid=${x.oid}">Giao việc</a>
                                                    </c:when>
                                                    ...
                                                    <c:otherwise>
                                                        <form action="changestatus" method="post">
                                                            ...
                                                            <input hidden="" value="${x.oid}" name="oid">
                ...
                <nav style="margin: 20px auto; width: 500px" aria-label="...">              
                    <ul class="pagination pagination-lg">
                        <c:forEach begin="1" end="${totalPage}" var="i">
                            <li class="page-item ${indexPage == i?"active":""}"><a class="page-link" href="order_all?page=${i}">${i}</a></li>
                        </c:forEach>
                    </ul>
                </nav>
        ...
        <script>
                                ...
                                function showMess(id) {
                                    var option = confirm('Xóa đơn hàng với id = ' + id + ' ???');
                                    if (option === true) {
