            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-10 ftco-animate">
                        <form action="orderproc" method="post" class="billing-form">
                            <h3 class="mb-4 billing-heading">Phân công đơn hàng</h3>                            
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="streetaddress">Đơn háng sô:</label>
                                    <input type="text"  name="oid" value="${requestScope.donhang}" style="width: 30%; text-align: center"><br> 
                                    <label for="streetaddress">Chọn nhân viên thực hiện đơn:</label>
                                    <select name="staff">
                                        <c:forEach items="${requestScope.listS}" var="s">
                                            <option value="${s.idStaff}">${s.name}</option>
                                        </c:forEach>
                                    </select>                                                                   
                                </div>                              
                            </div>                                           
                            <div class="col-md-12">
                                <div class="cart-detail bg-light p-3 p-md-4">
                                    <input class="btn btn-primary py-3 px-4" type="submit" value="Giao đơn" style="width: 30%"/>
                                </div>
                            </div>                           
                        </form>  
                        <div class="col-md-12">
                            <table border="1"style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center">Khả năng</th>
                                    </tr>
                                </thead>
                                <c:forEach items="${requestScope.listS}" var="l">
                                    <tbody>
                                        <tr >
                                            <td style="padding-left: 5%">${l.name}</td>
                                            <td style="padding-left: 5%">${l.ability}</td>
                                        </tr>
                                    </tbody>
                                </c:forEach>
