...
<html lang="en">
    ...
    <body class="goto-here">
            ...
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-9 ftco-animate text-center">
                        ...
                        <h1 class="mb-0 bread">Thống kê dữ liệu</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="ftco-section ftco-cart">           
            <div class="container">
                <div><a href="manageproduct" style="color: #005cbf; font-size: 20px;text-align: end">Quay lại</a></div><br>
                <div class="row">                  
                            ...
                            <table class="table">                                                            
                                <tbody>
                                    <tr class="text-center">
                                        ...
                                        <td>${requestScope.Allquantiy}&nbsp;sản phẩm</td>
                                    </tr>
                                    <tr class="text-center">
                                        <td>Tổng số đơn hàng :</td>
                                        <td>${requestScope.allOrder}&nbsp;đơn hàng</td>
                                    </tr>
                                    <tr class="text-center">
                                        <td>Lợi nhuận trung bình 1 ngày :</td>
                                        <td>${requestScope.money}&nbsp;VNĐ</td>
                                    </tr>
                                </tbody>
                                ...
                                <c:forEach items="${requestScope.listP}" var="x">
                                    <tbody>
                                        <tr class="text-center">
                                            ...
                                            <td class="price">
                                                <c:forEach items="${requestScope.staticP}" var="m">
                                                    <c:if test="${x.id == m.pid}">${m.sl}</c:if>
                                                </c:forEach>
                                            </td>
                ...
                <nav style="margin: 20px auto; width: 500px" aria-label="...">              
                    <ul class="pagination pagination-lg">
                        <c:forEach begin="1" end="${totalPage}" var="i">
                            <li class="page-item ${indexPage == i?"active":""}"><a class="page-link" href="statistic?page=${i}">${i}</a></li>
                            </c:forEach>
                    </ul>
                </nav>
            </div>
