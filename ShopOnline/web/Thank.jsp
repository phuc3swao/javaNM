<%-- 
    Document   : Thank
    Created on : Mar 13, 2022, 10:12:05 PM
    Author     : Admin
--%>
...
<html lang="en">
    ...
    <body class="goto-here">
                    ...
                    <div class="col-lg-4 text-center d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services p-4 py-md-5">
                            ...
                            <div class="media-body">
                                ...
                                <p>Miễn phí giao hàng khi đơn hàng của bạn trên 1.000.000VNĐ</p>
                            </div>
                        </div>      
                    </div>
                    <div class="col-lg-4 text-center d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services p-4 py-md-5">
                            ...
                            <div class="media-body">
                                ...
                                <p>Tính năng chưa được phát triển, mong bạn hãy chờ đợi trong tương lai</p>
                            </div>
                        </div>    
                    </div>
                    <div class="col-lg-4 text-center d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services p-4 py-md-5">
                            ...
                            <div class="media-body">
                                ...
                                <p>Hiện tại chỉ cung cấp phương thức thanh toán trực tiếp tại khi nhân hàng, nên tính bảo mật cực cao, kính mong quý khách không boom hàng.</p>
                            </div>
                        </div>      
                    </div>
                </div>
        ...
        <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
            <div class="container">
                <h1>Cám ơn bạn đã ủng hộ chúng tôi.<br> Thank you very much !</h1>
            </div>
        </section>
