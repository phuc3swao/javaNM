            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-10 ftco-animate">
                        <form action="update_p" method="post" class="billing-form">
                            <h3 class="mb-4 billing-heading">Cập nhật Sản phẩm</h3>
                            <div class="row align-items-end">                               
                            </div>                               
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="country" >ID sản phẩm : <input type="text" name="id" value="${requestScope.product.id}" readonly="readonly" /></label><br>
                                    <label for="country" >Tên sản phẩm:</label><br>                                      
                                    <input type="text" name="nameSP" placeholder="${requestScope.product.nameSP}">
                                    <label for="country">Hình ảnh:</label><br>                                      
                                    <input type="text" name="image" placeholder="${requestScope.product.image}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"  name="price" placeholder="${requestScope.product.price}" ><br>
                                    <label for="streetaddress">Màu:</label>
                                    <input type="text"  name="color" placeholder="${requestScope.product.color}" >
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" placeholder="${requestScope.product.title}" >
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="postcodezip">Mô tả</label>
                                    <textarea  name="description" rows="4" cols="20" placeholder="${requestScope.product.descrption}" style="width: 100%">
                                    </textarea>
                                </div>
                            </div>
                            <div class="w-100"></div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cateid" placeholder="${requestScope.product.cateid}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <input class="btn btn-primary py-3 px-4" type="submit" value="Cập Nhật" style="width: 30%"/>
                        </form><!-- END -->
