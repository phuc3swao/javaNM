                    ...
                    <div class="col-lg-12 d-block">
                        <div class="row d-flex">
                            ...
                            <div class="col-md pr-4 d-flex topper align-items-center">
                                ...
                                <span class="text">phuclhhe153529@fpt.edu.vn</span>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row block-12">
                    ...
                    <div class="col-md-8 order-md-last d-flex" >
                        ...
                        <form action="changepass" class="bg-white p-5 contact-form" method="post">
                            ...
                            <div class="form-group">
                                <input type="password" name="cpass" class="form-control" placeholder="Xác nhâ mật khẩu mới">
                            </div> 
                            <div class="form-group">
                                <input type="submit" value="Xác nhận" class="btn btn-primary py-3 px-5">
                                <h6 style="padding-top: 7px; color: tomato">${requestScope.fail}</h6>
                                <h6 style="padding-top: 7px; color: lime">${requestScope.succ}</h6>
                                <a href="forgotpass" style="color: fuchsia"></a>
                            </div>
                        </form>
                    </div> 
                    <div class="col-md-2 order-md-last d-flex" ></div>
