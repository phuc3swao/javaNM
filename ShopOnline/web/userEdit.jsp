            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-10 ftco-animate">
                        <form action="userEdit" method="post" class="billing-form">
                            <h3 class="mb-4 billing-heading">Change info user</h3>                            
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="streetaddress">Username:</label><br>
                                    <input type="text"  name="user" value="${requestScope.userinfo.user}" readonly=""style="width: 100%"><br> 
                                    <label for="streetaddress">Password:</label><br>
                                    <input type="password"  name="pass" value="${requestScope.userinfo.pass}" readonly=""style="width: 100%"><br>
                                    <label for="streetaddress">Info/Funtion:</label>
                                    <select name="info">
                                        <option value="">Customer</option>
                                        <c:choose>
                                            <c:when test="${requestScope.userinfo.info == 'Admin'}">
                                        ...
                                        <c:choose>
                                            <c:when test="${requestScope.userinfo.info == 'Manager'}">
                                        ...
                                        <c:choose>
                                            <c:when test="${requestScope.userinfo.info == 'Staff'}">
                            ...
                            <div class="row mt-5 pt-3 d-flex">
                                <div class="col-md-6">
                                    <div class="cart-detail bg-light p-3 p-md-4">
                                        <input class="btn btn-primary py-3 px-4" type="submit" value="Edit" style="width: 100%"/>
                                    </div>
